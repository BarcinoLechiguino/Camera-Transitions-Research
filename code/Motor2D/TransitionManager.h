...
public:
	...
	Transition* CreateSlide(SCENES next_scene, float step_duration = 0.5f, bool non_lerp = false, bool enter_from_left = true, Color slide_colour = Black);
	Transition* CreateWipe(SCENES next_scene, float step_duration = 0.5f, bool non_lerp = false, bool enter_from_left = true, Color wipe_colour = Black);
